...
7. 시간 표기: 원문의 모든 시간은 독일 현지 시간이므로, 번역 시 독일 현지 시간과 한국 시간(KST)을 함께 표기합니다.
 기사 속 날짜의 서머타임 적용 여부를 고려하여 시차(7시간 또는 8시간)를 정확히 계산하세요.
 (예:독일 현지 시간 [날짜] [시간] (한국 시간 [날짜] [시간]), 예시: 7월 15일 15:00 (한국 시간 22:00)
